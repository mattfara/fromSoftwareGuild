...
public class ContactListDaoDbImpl implements ContactListDao {
    ...
    private static final String SQL_UPDATE_CONTACT
            ...
            + "phone = ?, email = ? "
            + "where contact_id = ?"; //don't forget this last part!!!
    ...
    @Override //still no isolation leve, rollback, or timeout rules mentioned
    ...
    public Contact addContact(Contact contact) {
        ...
        // row in the database //if multiple inserts, returns first row that was inserted
        //not last
