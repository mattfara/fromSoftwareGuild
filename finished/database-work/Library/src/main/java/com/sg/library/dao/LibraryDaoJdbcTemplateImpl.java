...
public class LibraryDaoJdbcTemplateImpl implements LibraryDao {
    ...
    //begin author prepared statements
    ...
    //end author prepared statements
    //begin books and books_authors prepared statements

    //this one has publisher_id as a foreign key, and no reference to author
    ...
    private static final String SQL_SELECT_BOOKS_BY_AUTHOR_ID = "select b.book_id, b.isbn, b.title, b.publisher_id, b.price, "
            + "b.publish_date from books b join books_authors ba on author_id "
            + "where b.book_id = ba.book_id "
            + "and ba.author_id  =  ?";

    //end books and book_authors prepared statements
    //begin publisher related prepared statements
    ...
    //code: poptart
    //this is used after some changes are made to book
    //ultimately this just updates the book_authors table
    private void insertBooksAuthors(Book book) {
        final int bookId = book.getBookId();
        final List<Author> authors = book.getAuthors(); //taking from the incoming Book object

        for (Author currentAuthor : authors) { //loop through authors list, for each, put the two pieces of info into bridge table
    ...
    public void addBook(Book book) {
        ...
        insertBooksAuthors(book); //code: poptart -- takes care of bridge table

    }

    @Override
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    //needs an annotation because we have two statements running
    ...
    public void updateBook(Book book) {
        ...
        insertBooksAuthors(book); //helper method -- puts the updated book into the bridge table
    }
    ...
    public Book getBookById(int id) {
        try {
            ...
            book.setAuthors(findAuthorsForBook(book)); //helper methods accessing bridge table
    ...
    public void addPublisher(Publisher publisher) {
        //first statement
        jdbcTemplate.update(SQL_INSERT_PUBLISHER, publisher.getName(), publisher.getStreet(), publisher.getCity(),
                publisher.getState(),
                publisher.getZip(),
                publisher.getPhone());
        //second statement
    ...
    private static final class BookMapper implements RowMapper<Book> {
        ...
        //it leaves out fields that helper methods above will get....
        //code: poptart
        @Override
