...
public class Book {
    ...
    private Publisher publisher; //each book has one and only one publisher in this library
    private List<Author> authors; //each book can have one or more authors //Code: poptart
