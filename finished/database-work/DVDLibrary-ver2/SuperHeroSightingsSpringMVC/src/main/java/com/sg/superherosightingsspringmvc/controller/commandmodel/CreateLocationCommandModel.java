...
//    private AddressCommandModel address;
    ...
    @Length(min = 1, max = 20, message = "Latitude must be between one and 20 characters in length.")
    private String latitude;

    @NotEmpty(message = "You must supply a longitude.")
    @Length(min = 1, max = 20, message = "Longitude must be between one and 20 characters in length.")
