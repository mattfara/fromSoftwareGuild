...
<html>
    <head>
        <title>Delete Super Person</title>
        <!-- Bootstrap core CSS -->
            ...
            <div class="row">
                <div class="col-md-1 col-md-offset-3">
                    <sf:form class="form-horizontal" role="form" modelAttribute="button"
                             action="redirectToSuperPersonsPage" method="POST">                             
                        <input type="submit" class="btn btn-default" name="button" value="Cancel" />
                    </sf:form>
                </div>
                <div class="col-md-8">
                    <sf:form class="form-horizontal" role="form" modelAttribute="button"
                             action="deleteSuperPerson" method="POST">
                        <input type="hidden" name="superPersonToDelete" value="${superPersonToDelete}" />
