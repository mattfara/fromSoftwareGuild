...
//using == doesn't pass the conditional, and forces the else block
//use the .toLowerCase method on the user input, and compare that to marty mcfly with all lower case